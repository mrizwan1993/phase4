Rails.application.routes.draw do
  get 'admin_store_flavors_view/index'
  get 'employee_active_stores_view/index'
...
#   get 'contracted' => 'books#contracted', as: :contracted_books
  get "shifts/:id", to: "shifts#show", as: "show_shift"
  get "employees/:id", to: "employees#show", as: "show_employee"
  get "shift_jobs/:id", to: "shift_jobs#show", as: "show_shift_job"
