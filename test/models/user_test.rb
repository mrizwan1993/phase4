...
class UserTest < ActiveSupport::TestCase
  ...
  context "Creating a context for employees" do
    ...
    # test the callback is working 'reformat_email'
    should "shows that Ben's email is stripped of non-digits" do
      assert_equal "4122682323", @ben.email
    end
